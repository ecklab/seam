...
To use the Shiny application shipped with the package, first run the `setup.R` script. This script will take some time to run as it will download a large amount of data. This script only needs to be run once.
